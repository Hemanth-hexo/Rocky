...
ALL_FUNCTIONS = {**TOOL_FUNCTIONS, **OBSIDIAN_FUNCTIONS, **GITHUB_FUNCTIONS, **PROFILE_FUNCTIONS, **PROJECT_FUNCTIONS}
ALL_SCHEMAS = TOOL_SCHEMAS + OBSIDIAN_SCHEMAS + GITHUB_SCHEMAS + PROFILE_SCHEMAS + PROJECT_SCHEMAS
